  ...
  return (
    <div className="container">
      ...
      <div className="options-container">
        <button className="App-button-green" onClick={() => {navigate("/JobDescriptionUpload");}}>Upload Job Description</button>
        <button className="App-button-green" onClick={() => {navigate("/CvUpload");}}>Create with AI Interview</button>
      </div>
